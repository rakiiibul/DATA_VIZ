...
### 2.11 This visualization illustrates that most of the time light engine located in fronal of the car.<a name="carpl"></a>
```{r,echo=FALSE}
car_s %>%
ggplot(aes(x =price ,
fill = carbody,
...
Thanks to Roland Krause for GGplot2 slide
